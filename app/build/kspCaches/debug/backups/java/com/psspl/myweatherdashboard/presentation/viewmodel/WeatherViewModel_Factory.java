...
public final class WeatherViewModel_Factory implements Factory<WeatherViewModel> {
  ...
  private final Provider<GetWeeklyWeatherUseCase> getWeeklyWeatherUseCaseProvider;
  ...
  public WeatherViewModel_Factory(
      ...
      Provider<GetWeeklyWeatherUseCase> getWeeklyWeatherUseCaseProvider,
  ...
  public static WeatherViewModel newInstance(GetCurrentWeatherUseCase getCurrentWeatherUseCase,
    ...
    return new WeatherViewModel(getCurrentWeatherUseCase, getHourlyWeatherUseCase, getWeeklyWeatherUseCase, getLocationNameUseCase);
  }
}
