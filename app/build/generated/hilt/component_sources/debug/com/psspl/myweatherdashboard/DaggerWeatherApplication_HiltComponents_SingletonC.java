...
import com.psspl.myweatherdashboard.di.LocationModule_ProvideFusedLocationClientFactory;
import com.psspl.myweatherdashboard.di.LocationModule_ProvideLocationTrackerFactory;
import com.psspl.myweatherdashboard.di.NetworkModule_ProvideMoshiFactory;
import com.psspl.myweatherdashboard.di.NetworkModule_ProvideOkHttpClientFactory;
import com.psspl.myweatherdashboard.di.NetworkModule_ProvideRetrofitFactory;
import com.psspl.myweatherdashboard.di.NetworkModule_ProvideWeatherApiFactory;
...
import com.psspl.myweatherdashboard.domain.usecase.GetWeeklyWeatherUseCase;
import com.psspl.myweatherdashboard.presentation.viewmodel.WeatherViewModel;
import com.psspl.myweatherdashboard.presentation.viewmodel.WeatherViewModel_HiltModules;
import com.psspl.myweatherdashboard.presentation.viewmodel.WeatherViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.psspl.myweatherdashboard.presentation.viewmodel.WeatherViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerWeatherApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends WeatherApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(WeatherViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, WeatherViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends WeatherApplication_HiltComponents.ViewModelC {
    ...
    GetHourlyWeatherUseCase getHourlyWeatherUseCase() {
      return new GetHourlyWeatherUseCase(singletonCImpl.bindWeatherRepositoryProvider.get());
    }

    GetWeeklyWeatherUseCase getWeeklyWeatherUseCase() {
      return new GetWeeklyWeatherUseCase(singletonCImpl.bindWeatherRepositoryProvider.get());
    }

    GetLocationNameUseCase getLocationNameUseCase() {
      return new GetLocationNameUseCase(singletonCImpl.bindWeatherRepositoryProvider.get());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(WeatherViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (weatherViewModelProvider))));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.psspl.myweatherdashboard.presentation.viewmodel.WeatherViewModel
          return (T) new WeatherViewModel(viewModelCImpl.getCurrentWeatherUseCase(), viewModelCImpl.getHourlyWeatherUseCase(), viewModelCImpl.getWeeklyWeatherUseCase(), viewModelCImpl.getLocationNameUseCase());
  ...
  private static final class SingletonCImpl extends WeatherApplication_HiltComponents.SingletonC {
    ...
    Provider<FusedLocationProviderClient> provideFusedLocationClientProvider;

    Provider<LocationTracker> provideLocationTrackerProvider;

    Provider<WeatherRepositoryImpl> weatherRepositoryImplProvider;

    Provider<WeatherRepository> bindWeatherRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideWeatherApiProvider = DoubleCheck.provider(new SwitchingProvider<WeatherApi>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.psspl.myweatherdashboard.data.repository.WeatherRepositoryImpl
          return (T) new WeatherRepositoryImpl(singletonCImpl.provideWeatherApiProvider.get(), singletonCImpl.provideLocationTrackerProvider.get());

          case 1: // com.psspl.myweatherdashboard.data.network.WeatherApi
          return (T) NetworkModule_ProvideWeatherApiFactory.provideWeatherApi(singletonCImpl.provideRetrofitProvider.get());
          ...
          case 5: // com.psspl.myweatherdashboard.data.location.LocationTracker
          return (T) LocationModule_ProvideLocationTrackerFactory.provideLocationTracker(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.provideFusedLocationClientProvider.get());
